...
- Name: project.spec.ts >> Project List & Browse >> should browse project list as public
- Location: tests\project.spec.ts:5:3
...
Locator: getByText(/找项目|项目/)
Expected: visible
Error: strict mode violation: getByText(/找项目|项目/) resolved to 6 elements:
    1) <a href="/projects" data-v-8da451f1="" aria-current="page" class="router-link-active router-link-exact-active nav-link active">找项目</a> aka getByRole('link', { name: '找项目' })
    2) <h2 data-v-00cc3a23="">找项目</h2> aka getByRole('heading', { name: '找项目' })
    3) <p data-v-00cc3a23="">浏览最新项目，找到适合你的机会</p> aka getByText('浏览最新项目，找到适合你的机会')
    4) <h4 data-v-00cc3a23="">项目分类</h4> aka getByRole('heading', { name: '项目分类' })
    5) <h4 data-v-00cc3a23="">项目类型</h4> aka getByRole('heading', { name: '项目类型' })
    6) <span data-v-00cc3a23="" class="result-count">共 0 个项目</span> aka getByText('共 0 个项目')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText(/找项目|项目/)
