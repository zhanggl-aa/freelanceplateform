...
- Name: project.spec.ts >> Project List & Browse >> should view project detail
- Location: tests\project.spec.ts:27:3
...
Expected pattern: /\/projects\/[a-f0-9-]+/
Received string:  "http://localhost:3002/projects"
```
