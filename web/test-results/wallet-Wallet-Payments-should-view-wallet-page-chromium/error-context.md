...
- Name: wallet.spec.ts >> Wallet & Payments >> should view wallet page
- Location: tests\wallet.spec.ts:4:3
...
Locator: getByText(/我的钱包|钱包/)
Expected: visible
Error: strict mode violation: getByText(/我的钱包|钱包/) resolved to 2 elements:
    1) <h2 data-v-d538f058="">我的钱包</h2> aka getByRole('heading', { name: '我的钱包' })
    2) <li tabindex="-1" role="menuitem" aria-disabled="false" data-el-collection-item="" class="el-dropdown-menu__item">…</li> aka getByLabel('张总').getByText('我的钱包')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText(/我的钱包|钱包/)
